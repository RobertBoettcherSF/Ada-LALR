...
procedure Tests is
   ...
   S_Sym    : constant Non_Terminal_ID := 501;
   E_Sym    : constant Non_Terminal_ID := 502;
   ...
   Goto_Tab : constant Goto_Table (0 .. 4, 501 .. 502) := (
      0      => (502 => 1, others => Invalid_State),
...
begin
   ...
   begin
      ...
      Map := Generate_LALR_Mapping (Massive);
